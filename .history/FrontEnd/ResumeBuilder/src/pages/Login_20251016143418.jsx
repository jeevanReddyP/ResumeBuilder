...
import bgimage from "../assets/images/Resume.png";
export default function Login() {
  ...
  return (
    ...
    >
      <div className="bg-opacity-90 p-10 rounded-xl  w-full max-w-md ">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold text-red-200">ResumeBuilder</h1>
          <p className="text-red-200 mt-2">Build your professional resume easily</p>
        </div>
