  ...
  return (
    ...
    >
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
        ...
        <button 
        type="submit"
        className="w-full bg-indigo-600 text-white py-2 rounded-lg hover:bg-indigo-700 className="w-full p-3 mb-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500""
        >Register</button>
      </div>
    </form>
  );
